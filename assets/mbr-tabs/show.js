...
if (abtElement.style.display === "none") { abtElement.style.display = "block"; abtElement.classList.add('scroll-box'); button.textContent = 'Show Less'; } else { abtElement.style.display = "none"; button.textContent = 'Learn More';} }
